export { default as AdminCategory } from './admin/category';
export { default as AdminCart } from './admin/users';
export { default as AdminCategoryCreate } from './admin/category/add-category';
export { default as AdminProduct } from './admin/services';
export { default as AdminDashboard } from './admin/dashboard';
export { default as AdminUserLists } from './admin/users';
export { default as AdminAddProduct } from './admin/services/add-service';
export { default as AdminLogin } from './admin/login';
export { default as AdminOrders } from './admin/order';
...
export { default as Service } from './public/services/service';
